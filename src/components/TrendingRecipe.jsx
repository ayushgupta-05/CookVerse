                ...
                <div className="relative bg-gray-900 rounded-xl shadow-xl shadow-black/50 overflow-hidden group transform transition duration-500 cursor-pointer border border-gray-800 hover:shadow-blue-600/50 mb-5">
                  ...
                  <div className="flex justify-center items-center p-5">
                    <img
                      ...
                      alt=""
                      className="h-[140px] w-[200px] rounded-xl border border-yellow-400 transition duration-500 group-hover:scale-105"
                    />
                  </div>
                  <div className="p-2 text-center">
        <h5 className="text-lg pb-3 font-bold text-yellow-300 mb-1 group-hover:text-blue-400 transition duration-300">
          {meal.strMeal}
        </h5>
      </div>
                </div>
